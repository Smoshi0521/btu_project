...
function Navbar({ setOpenMenu }: Props) {
  ...
  return (
    <nav className={`${lexend.className} ${scrollY > 200 ? "shadow-2xl" : ""} font-medium w-full bg-transparent fixed top-0 z-50 px-2 h-16 flex justify-between duration-300`}>
      ...
      <AnimatePresence>
        {
          showMenu ?
            <motion.div
              ...
              className='w-full h-screen z-40 bg-black bg-opacity-50 absolute left-0 backdrop-blur-xl lg:hidden'>
